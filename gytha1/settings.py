"""
Django settings for gytha1 project.
"""
...
DATATYPE_LOCATIONS.append('gytha1.datatypes')
FUNCTION_LOCATIONS.append('gytha1.functions')
ETL_MODULE_LOCATIONS.append('gytha1.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('gytha1.search_components')
...
SECRET_KEY = 'x!&rlazrb!q2-p9il$xql=z9j$i_7_n#1jm=x2=#uk-1z46+2g'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'gytha1.urls'
...
ELASTICSEARCH_PREFIX = 'gytha1'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'gytha1.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'gytha1.wsgi.application'
